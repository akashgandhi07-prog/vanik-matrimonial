...
| **Categories of personal data** | Names, demographics, eligibility and matching fields (including religion where provided), addresses, telephone, images, safeguarding notes, transactional email metadata; optional IP-derived hash at registration submit when enabled |
