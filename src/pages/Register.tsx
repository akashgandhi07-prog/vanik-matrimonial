  ...
  async function submitAll(e: React.FormEvent) {
    ...
    try {
      const payload = {
        ...
        home_address_line1: titleCaseIfAllCaps(sanitizeText(form.home_address_line1, 200)),
        home_address_city: titleCaseIfAllCaps(sanitizeText(form.home_address_city, 100)),
        home_address_postcode: sanitizeText(form.home_address_postcode, 20),
        home_address_country: titleCaseIfAllCaps(sanitizeText(form.home_address_country, 80)),
        ...
        nationality: titleCaseIfAllCaps(sanitizeText(form.nationality, 100)),
        ...
        diet: form.diet,
        hobbies: sentenceCaseIfAllCaps(sanitizeText(form.hobbies, 400)),
