      ...
      <div className="layout-max" style={{ marginTop: 24, marginBottom: 48 }}>
        <div className="card prose-safe" style={{ maxWidth: 720, marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <p style={{ color: 'var(--color-text-secondary)', fontSize: 15 }}>
            Your suggestions help us improve the Vanik Matrimonial Register. Submissions go straight to the
            register team{signedInNotice ? ' and are linked to your member account internally' : ''}. Nothing
            you write here appears on your public profile or in search results.
          </p>
